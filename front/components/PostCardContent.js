...
const PostCardContent = ({ postData, editMode, onCancelRevisePost, onRevisePost }) => {
  ...
  <div>
    ...
    ? (
      <>
        ...
        <Button.Group>
          <Button loading={revisePostLoading} onClick={onRevisePost(editText)}>수정</Button>
          <Button type="danger" onClick={onCancelRevisePost}>취소</Button>
        </Button.Group>        
      </>
    )
